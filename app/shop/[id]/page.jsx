...
//                 <button
//                   key={idx}
//                   className="border py-1 px-3  text-gray-700 hover:bg-gray-200"
//                 >
//                   {size}
//                 </button>
//               ))}
...
//             <div className="flex items-center border w-24 justify-between px-5 py-1.5 ">
...
//             <Button className="flex items-center gap-2 rounded-none  text-white px-6 py-2 ">
...
import { useParams, useRouter } from "next/navigation"; // ✅ Next.js থেকে import
import { Button } from "@/components/ui/button";
import axios from "axios";
import { CiStar } from "react-icons/ci";
import { FaRegHeart } from "react-icons/fa";
